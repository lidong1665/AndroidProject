...
public class JelloToggle extends FrameLayout {
    ...
    private void init() {
        ...
        mCheckedDrawable = getResources().getDrawable(R.mipmap.checked);
        mOnCheckDrawable = getResources().getDrawable(R.mipmap.check_on);
        mUnCheckedDrawable = getResources().getDrawable(R.mipmap.uncheck);
        setJelloState();
